...
Dim sleepX
sleepX = 2000 ' Time to sleep between setting changes
...
End Sub
' Cooling scenario A
Sub ScenarioA(raDamper1,raDamper2,oaDamper1,oaDamper2,blowerControl1,blowerControl2,hv4Damper,rhSp1,rhSp2)
	...
	changeControl(hv4DamperMode, Hv4Damper, hv4Damper, "manual")
	changeControl(ahu1RhSp, ahu1RhSp, rhSp1, "manual")
	changeControl(ahu2RhSp, ahu2RhSp, rhSp2, "manual")
